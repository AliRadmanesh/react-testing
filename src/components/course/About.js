...
export default function About({ description }) {
  useEffect(() => {
    document.querySelector('.course-about-description').innerHTML = description;
  });
  ...
  return (
    <div className="container">
      <div className="course-about bg-white tw-rounded-xl tw-shadow-lg tw-p-4 lg:tw-p-5 tw-mt-4">
        ...
        <p className="text-gray tw-mt-4 tw-text-sm tw-font-normal font-iranyekan-num 2xl:tw-text-lg course-about-description" />
      </div>
    </div>
  );
}
